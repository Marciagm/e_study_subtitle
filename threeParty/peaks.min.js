...
"use strict";var WaveformData=require("../core.js");module.exports=function(e,t){var a=e.scale,r=e.scale_adjuster;return function(e){var n,s,f=Math.floor(e.length/a),o=20,l=new DataView(new ArrayBuffer(o+2*f)),u=1/0,v=-(1/0),h=a,c=e.length;l.setInt32(0,1,!0),l.setUint32(4,1,!0),l.setInt32(8,e.sampleRate,!0),l.setInt32(12,a,!0),l.setInt32(16,f,!0),n=e.getChannelData(0),s=e.getChannelData(0);for(var i=0;c>i;i++){var D=(n[i]+s[i])/2*r;u>D&&(u=D,-128>u&&(u=-128)),D>v&&(v=D,v>127&&(v=127)),0===--h&&(l.setInt8(o++,Math.floor(u)),l.setInt8(o++,Math.floor(v)),u=1/0,v=-(1/0),h=a)}t(new WaveformData(l.buffer,WaveformData.adapters.arraybuffer),e)}};
...
var Konva=require("konva");module.exports={init:function(a,t,e){var r,i,o,n=e,s=n.peaks.time.getCurrentTime(),m=[],d=30;n.segmentLayer&&(n.segmentLayer.setVisible(!1),n.pointLayer.setVisible(!1)),a>t&&(d=15);for(var l=0;d>l;l++){var p=Math.round(t+(l+1)*(a-t)/d),u=n.width*p/n.rootData.adapter.sample_rate;if(s>=0&&0+u/2>=s)r=0,i=0;else if(s<=n.rootData.duration&&s>=n.rootData.duration-u/2)o=n.rootData.duration-u,r=o*n.rootData.adapter.sample_rate/t,i=o*n.rootData.adapter.sample_rate/p;else{var D=s*n.rootData.adapter.sample_rate/t;r=D-n.width/2;var h=s*n.rootData.adapter.sample_rate/p;i=h-n.width/2}0>r&&(r=0);var v=n.rootData.resample({scale:p,input_index:Math.floor(r),output_index:Math.floor(i),width:n.width});m.push(v),t=p}return new Konva.Animation(this.onFrameData(e,m),e)},onFrameData:function(a,t){var e=a;return e.intermediateData=null,function(a){t.length?(e.intermediateData=t.shift(),e.zoomWaveformLayer.draw()):(this.stop(),e.intermediateData=null,e.segmentLayer.setVisible(!0),e.pointLayer.setVisible(!0),e.seekFrame(e.data.at_time(e.peaks.time.getCurrentTime())))}}};
